...
function Error(props: { title?: string; message?: string; timeout: number }) {
  ...
  return (
    <div className="flex flex-col justify-center text-center items-center gap-4 w-fit h-screen m-auto">
      {/* Title */}
      <h1 className="mt-10 text-5xl font-bold style1 !leading-loose">{title}</h1>
      ...
      <h1 className="mt-10 text-5xl font-bold style1 !leading-loose invisible shrink overflow-clip">{title}</h1>
